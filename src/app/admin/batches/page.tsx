    ...
    <AdminListPage
      ...
      filters={
        <FilterBar>
          ...
          />
          <div>
            <label className="mb-1 block text-caption font-medium text-muted" htmlFor="filter-from">
              Starts from
            </label>
            <Input id="filter-from" name="from" type="date" defaultValue={sp.from ?? ""} />
          </div>
          <div>
            <label className="mb-1 block text-caption font-medium text-muted" htmlFor="filter-to">
              Starts until
            </label>
      ...
      pagination={isEmpty ? undefined : <Pagination page={data.meta.page} totalPages={data.meta.totalPages} total={data.meta.total} limit={data.meta.limit} hrefFor={pageHref("/admin/batches", sp)} />}
    >
      {isEmpty ? (
