...
export default async function InboxPage({ searchParams }: { searchParams: Promise<RawSearchParams> }) {
  ...
  return (
    <div>
      <PageHeader title="Inbox" mobileTitle="Inbox" description={data.unread ? `${data.unread} unread notification${data.unread === 1 ? "" : "s"} addressed to you.` : "Announcements and system notifications addressed to you."} />
