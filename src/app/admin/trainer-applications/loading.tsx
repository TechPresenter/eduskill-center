...
/**
 * Route skeleton for trainer applications. It mirrors the real page's blocks in the same order and at the same
...
export default function Loading() {
  return (
    <div className="animate-fade-in space-y-4 motion-reduce:animate-none" aria-busy="true" aria-label="Loading trainer applications">
